export const countryOptions = [
  ...
  { code: 'GBN', name: 'British National (Overseas)' },
  { code: 'GBO', name: 'British Overseas Citizen' },
  { code: 'GBD', name: 'British Overseas Territories Citizen' },
  { code: 'GBP', name: 'British Protected Person' },
  { code: 'GBS', name: 'British Subject' },
  ...
  { code: 'EUE', name: 'European Union (EU)' },
  ...
  { code: 'QAT', name: 'Qatar' },
  { code: 'RKS', name: 'Republic of Kosovo' },
  { code: 'UNK', name: 'Resident of Kosovo to whom a travel document has been issued by the United Nations Interim Administration Mission in Kosovo (UNMIK)' },
  ...
  { code: 'UNO', name: 'United Nations Organization or one of its officials' },
  { code: 'UNA', name: 'United Nations specialized agency or one of its officials' },
...
export const countryNameByCode = Object.fromEntries(countryOptions.map((entry) => [entry.code, entry.name])) as Record<string, string>